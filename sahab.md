...
- go-code ships through no-mistakes: full validation pipeline, green CI, sahab merge approval.
...
- At intake, **ask for the Linear project** when dispatching ship work if sahab did not name one (MET team has multiple projects — do not guess).
